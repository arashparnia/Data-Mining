...
# Data_Pclass1 <- Data_Pclass1[ , colSums(is.na(Data_Pclass1)) == 0]
# Data_Pclass1 <- data.frame(Data_Pclass1)
# Data_Pclass1 <- as.factor(Data_Pclass1)
write.csv(Data_Pclass1,file = "../../../Data/datacsv_Pclass1.csv")




sData_Pclass2 <- Data_Pclass2[ , colSums(is.na(Data_Pclass2)) == 0]
...
write.csv(Data_Pclass7,file = "../../../Data/datacsv_Pclass7.csv")
```
